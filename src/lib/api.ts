...
export const chatsAPI = {
    ...
    sendMessage: async (chatId: string, content: string, type: 'text' | 'image' | 'voice' | 'video' | 'doc' | 'call' | 'poll' | 'event' | 'audio' | 'contact' | 'location' = 'text', mediaUrl?: string, replyToId?: string) =>
